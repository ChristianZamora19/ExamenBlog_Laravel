      ...
      <div class="row">
         <div class="col-md-12">
            <div class="aboutheading">
               <h3>Programa <span class="orange_color">Maestro</span></h3>
            </div>
         </div>
      </div>
   </div>
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="full blog_cont">
                     <p>Consiste en un programa de producción a nivel superior que se usa para fijar el plan de producción de cualquier fábrica decidiendo qué, cuánto y en qué fecha se va a fabricar a medio plazo. Es una herramienta que nos permite cumplir en tiempo y forma con la demanda de los clientes, al mismo tiempo que cuidamos la rentabilidad del negocio.</p>
                  </div>
               </div>
            </div>
            <br>
            <div>
            <h2 align="center"><b>Tareas y Procesos de programa maestro</b></h2>
            <p>•Abrir un puerto local bien conocido al cual pueda acceder los clientes.
               <br>•Esperar las peticiones de los clientes.
               <br>•Elegir un puerto local para las peticiones que llegan en informar al cliente del nuevo puerto, (innecesario en la mayoría de los casos).
               <br>•Iniciar un programa esclavo o proceso hijo que atienda la petición en el puerto local, (el esclavo cuando termina de manejar una petición no se queda esperando por otras).
               <br>•Volver a la espera de peticiones mientras los esclavos, en forma concurrente, se ocupan de las anteriores peticiones.</p>
               
            </div>
            <div class="col-md-6">
               <img src="images/programa maestro2.png" alt="#" />
            </div>
