      ...
      <div class="row">
         <div class="col-md-12">
            <div class="aboutheading">
               <h3>Introducción <span class="orange_color">Cliente Servidor</span></h3>
            </div>
         </div>
      </div>
   </div>
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="full blog_cont">
                     ...
                     <h5>FEB 20 2022</h5>
                     <p>La red cliente-servidor es una red de comunicaciones en la cual los clientes están conectados a un servidor, en el que se centralizan los diversos recursos y aplicaciones con que se cuenta; y que los pone a disposición de los clientes cada vez que estos son solicitados.
                        <br> La expresión cliente servidor se utiliza en el ámbito de la informática. En dicho contexto, se llama cliente al dispositivo que requiere ciertos servicios a un servidor. La idea de servidor, por su parte, alude al equipo que brinda servicios a las computadoras (ordenadores) que se hallan conectadas con él mediante una red.
            ...
            <div class="row margin_top_30">
               ...
               <div class="col-md-6">
                  <div class="full blog_cont">
                     ...
                     <h5>FEB 20 2022</h5>
                     <p>Características, protocolos y componentes de los sistemas de información, para desarrollar los elementos funcionales de la arquitectura Cliente/Servidor.</p>
                  </div>
            ...
            <div class="row margin_top_30">
               ...
               <div class="col-md-6">
                  <div class="full blog_cont">
                     ...
                     <h5>FEB 20 2022</h5>
                     <p>Modelado en accesos de datos, API's, sockets y vista controlador para desarrollar programas de aplicación simples o multinivel.</p>
                  </div>
                  <div class="button_section full center margin_top_30">
